            ...
            success: function (data, textStatus) {
             ...
             //   alert(vdvthhaedwidth);
                ...
                for (var i = 1; i <= 7; i++) {
                   ...
                   var vDivthHead = $("<div style='margin:2px;height:33px;font-size:8px;display:inline-block;width:"+(vdvthhaedwidth)+"px' id=" + (id + 0) + ">" + vthHeadText + "</div>");
                ...
                */
                ...
                var vtdheadwidth = 100;//房间名称所在单元的长度大小
                    ...
                    if (vResvInfo != null && vResvInfo.length > 0)
                    {
                        ...
                        for (var i = 0; vResvInfo != null && i < vResvInfo.length; i++) {
                            ...
                            */
                            ...
                            var left = parseInt((vTetmpLeft - vOpenLeft + +parseInt(opentime / 10000) % 100 / 60) * thWidth) + thWidth + (2 * vcolum);
