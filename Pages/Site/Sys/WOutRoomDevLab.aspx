<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="WOutRoomDevLab.aspx.cs" Inherits="Sub_Device" %>
            ...
            $(function () {
                ...
                $("#btnNew").click(function () {
                    $.lhdialog({
                        ...
                        height: '300px',
                        lock: true,
                        content: 'url:Dlg/WNewLabOutRoom.aspx?op=new&dwLabClass=1025'
                    });
                });
                $(".ListTbl").UniTable();
