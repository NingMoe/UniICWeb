<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="DeviceAndKind.aspx.cs" Inherits="Sub_Device" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $(".OPTD").html('<div class="OPTDBtn">\
                    ...
                    <a class="setDevFar" href="#" title="设置经费分配比例"><img src="../../../themes/icon_s/17.png"/></a>\
                    </div>');
                $(".OPTDBtn").UIAPanel({
                ...
                $("#btnNew").button()
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewDeviceAndKind.aspx?op=new'
                    });
                });
