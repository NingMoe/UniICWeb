<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="WInRoomDevKind.aspx.cs" Inherits="Sub_Device" %>
                ...
                $("#btnNew").button()
                    .click(function () {
                        $.lhdialog({
                            ...
                            lock: true,
                            data: Dlg_Callback,
                            content: 'url:Dlg/WNewInRoomKind.aspx?op=new&dwClassKind=513'
                        });
                    });              
            });
