<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="DevKindCG.aspx.cs" Inherits="Sub_Room" %>
            ...
            $(function () {
                ...
                $("#btnDevKind").click(function () {
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewDevKindCG.aspx?op=new'
                    });
                });
                ...
                $(".setDevkindBtn").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewDevKindCG.aspx?op=set&id=' + dwDevKind
                    });
                });
