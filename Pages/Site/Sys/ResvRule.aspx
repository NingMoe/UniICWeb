        ...
        <script type="text/javascript">
            $(function () {
                ...
                $(".OPTD").html('<div class="OPTDBtn">\
                        ...
                        <a href="#" class="delResvRuleBtn" title="删除"><img src="../../../themes/iconpage/del.png""/></a>\<%if(ConfigConst.GCDebug==1){%><a class="CopyResvRule"  href="#" title="复制给其他设备"><img src="../../../themes/iconpage/edit.png"/></a>\<%}%></div>');
                $(".OPTDBtn").UIAPanel({
