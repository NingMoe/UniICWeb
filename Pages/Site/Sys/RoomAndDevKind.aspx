<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="RoomAndDevKind.aspx.cs" Inherits="Sub_Room" %>
            ...
            $(function () {
                ...
                $("#btnNewRoom").click(function () {
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewRoomAndDevKind.aspx?op=new'
                    });
                });
