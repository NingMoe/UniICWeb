<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="DeviceCG.aspx.cs" Inherits="Sub_Device" %>
            ...
            <div class="tb_infoInLine" style="margin: 5px 0px">
                <table style="width: 99%">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="szDevName" id="szDevName" /></td>
                        <!-- 
                    <th>资源编号:</th>
            ...
            $(function () {
                ...
                $(".setDev").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewDeviceCG.aspx?op=set&id=' + dwDevID
                    });
                });
                ...
                $("#btnNew").button()
                    .click(function () {
                        $.lhdialog({
                            ...
                            lock: true,
                            data: Dlg_Callback,
                            content: 'url:Dlg/NewDeviceCG.aspx?op=new'
                        });
                    });
