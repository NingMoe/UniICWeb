<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="WInRoomDev.aspx.cs" Inherits="Sub_Device" %>
            ...
            $(function () {
                ...
                $("#btnNewRoom").click(function () {
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/WNewDeviceAndRoom.aspx?op=new'
                    });
                });
