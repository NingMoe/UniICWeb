<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="WSetRoomInRoom.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="Form1" runat="server">
        <div class="formtitle"><%=m_Title %></div>
         <input id="dwDeptID" name="dwDeptID" type="hidden" />
         <input id="dwInClassKind" name="dwInClassKind" type="hidden" value="513" />
        <div class="formtable">
            <table>
                <tr>
                    <th>编号：</th>
