...
public partial class _Default : UniPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            {
                MessageBox(m_Request.szErrMessage, "新建楼宇失败", MSGBOX.ERROR, MSGBOX_ACTION.NONE);
            ...
            {
                MessageBox("新建楼宇成功", "提示", MSGBOX.SUCCESS, MSGBOX_ACTION.OK);
                UNIBUILDING newBuilding = new UNIBUILDING();
                newBuilding.dwCampusID = 1;
                newBuilding.szBuildingName = "第一12教学楼";
                newBuilding.szBuildingNo = "123";
                newBuilding.szBuildingURL = "url";
                m_Request.Device.BuildingSet(newBuilding, out newBuilding);
