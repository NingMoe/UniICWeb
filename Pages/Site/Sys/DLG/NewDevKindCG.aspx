<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewDevKindCG.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="Form1" runat="server">
        ...
        <div class="formtable">
            ...
            <input id="dwMinUsers" name="dwMinUsers" type="hidden" value="0" />
            <input id="dwMaxUsers" name="dwMaxUsers" type="hidden" value="0" />
