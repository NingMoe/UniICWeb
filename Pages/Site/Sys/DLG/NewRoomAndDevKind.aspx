<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewRoomAndDevKind.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            <table>
                ...
                <tr>                   
                    ...
                    <td>
                        <input type="text" id="szLabName" name="szLabName" /></td>            
                     <th>开放规则：</th>
                    <td>
                ...
                <tr> 
                    ...
                    <th>资源个数</th>
                    <td>
                        <input type="text" id="DevNum" name="DevNum" value="1" /></td>
                </tr>    
