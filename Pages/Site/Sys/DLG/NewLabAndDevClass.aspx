<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewLabAndDevClass.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th>校区：</th>
                    <td>
                        <select id="dwCampusID" name="dwCampusID"><%=m_Campu %></select></td>
                </tr>                  
                <tr>
