...
public partial class _Default : UniPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            uint uKindClass = (uint)newDevKind.dwClassKind;
          //  uKindClass = uKindClass | (uint)UNIDEVKIND.DWPROPERTY.DEVPROP_EXCLUSIVE;
            //newDevKind.dwClassKind = uKindClass;
            ...
            if (uNew == 1)
            {
                ...
                {
                    MessageBox("新建类型成功", "提示", MSGBOX.SUCCESS, MSGBOX_ACTION.OK);                   
                }
                else
                {
            ...
            {
                MessageBox(m_Request.szErrMessage, "新建类型失败", MSGBOX.ERROR, MSGBOX_ACTION.NONE);
            }
            else
            {
                MessageBox("新建类型成功", "提示", MSGBOX.SUCCESS, MSGBOX_ACTION.OK);
        ...
        m_KindProperty = GetAllInputHtml(CONSTHTML.checkBox, "dwProperty", "DevKindInRoom_dwProperty");
