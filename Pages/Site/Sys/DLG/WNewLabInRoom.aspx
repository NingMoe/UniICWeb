<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="WNewLabInRoom.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="Form1" runat="server">
        ...
        <div class="formtable">
            ...
            <input type="hidden" name="dwLabClass" id="dwLabClass" value="513" />
                        <table>
                <tr>
                    <th>编号：</th>
                    <td>
