<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="YardResvCheckMeetCalGet.aspx.cs" Inherits="_Default" %>
            ...
            <table class="DlgListTbl">
                ...
                <tr>
                 ...
                 <tr>
                    <th>多媒体：</th>
                    <td colspan="4">
                 <label><input name="resvPro3" class="prop_profit" type="radio" value="1" />&nbsp;使用多媒体&nbsp;</label>
                            <label><input name="resvPro3" type="radio" checked="checked" value="2" />&nbsp;不使用多媒体&nbsp;</label>
                        </td>
                        </tr>
                      ...
                      <th>公开状况：</th>
                    <td colspan="4">
                 <label><input name="resvPro4" class="prop_profit" type="radio"  checked="checked"  value="1" />&nbsp;公开&nbsp;</label>
                            <label><input name="resvPro4" type="radio"value="2" />&nbsp;不公开&nbsp;</label>
                        </td>
                        </tr>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <th colspan="1" style="width:120px">申请时间：</th>
                    <td colspan="4">
                        <div id="szCycRule">
                 ...
                 <tr>
                    <th colspan="1" style="width:120px">备注信息：</th>
                    <td colspan="4">
                        <%=szMemoYardResv %>
                    </td>
