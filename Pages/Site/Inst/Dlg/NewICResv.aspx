        ...
        <div class="formtable">
            <table>
                ...
                <tr>
                    <th>开始时间：</th>
                    <td>
                        <select name="startTimeHour" id="startTimeHour" style="width:60px">
                            <%=TimeHour %>
                        </select>时
                        <select  name="startTimeMin" id="startTimeMin" style="width:60px">
                            <%=TimeMin %>
                        </select>分
                     </td>
                    <th>结束时间：</th>
                    <td>
                         <select name="endTimeHour" id="endTimeHour" style="width:60px">
                            <%=TimeHour %>
                        </select>时
                        <select  name="endTimeMin" id="endTimeMin" style="width:60px">
                            <%=TimeMin %>
                        </select>分
                        </td>
                </tr>              
