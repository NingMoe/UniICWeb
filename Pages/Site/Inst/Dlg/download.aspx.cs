...
public partial class Page_download : UniPage
{
    protected string m_szFilePath = @"E:\实验室系统系统\FileServer\FILES";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        vrReq.dwSID = new UniDW(int.Parse(Request["ID"]));
