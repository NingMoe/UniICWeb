<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="YardResvCheckSport.aspx.cs" Inherits="_Default" %>
            ...
            <table class="DlgListTbl">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <!--<input type="text" id="dwMinAttendance" name="dwMinAttendance" style="width:40px;" />到 
                             <input type="text" id="dwMaxAttendance" name="dwMaxAttendance" style="width:40px;" />
                   -->
                             </td>
                </tr>
                <tr>
