<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="RDevUsingTableWeek.aspx.cs" Inherits="Sub_Course" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        ...
        <h2 style="margin-top: 10px; margin-bottom: 10px; font-weight: bold">星期使用率统计图</h2>
       <div>
               <div id="divsearch" class="tb_infoInLine" style="margin:0 auto;text-align:center">
                    <table style="margin:5px;width:99%">
                           <tr>
                            ...
                            <th class="thHead">往后周次:</th>
                            <td class="tdHead">
                            <select name="dwWeeks" id="dwWeeks">
                                <%=szWeeks %>
                             </select>
                            </td>
                        </tr>
