<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewRoomGroup.aspx.cs" Inherits="_Default"%>
...
<form id="Form1" runat="server">
    ...
    <div class="formtable">
        ...
        <table>
            <tr><th>组合名称：</th><td><input id="szRGName" name="szRGName" class="validate[required]" /></td></tr>
           
            <tr><th>勾选房间：</th><td><%=m_szRoom %></td></tr>
