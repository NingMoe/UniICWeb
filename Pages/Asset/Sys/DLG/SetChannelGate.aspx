<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetChannelGate.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            <table>
                <tr>
                    <th>编号：</th>
                    <td>
                        <input type="text" id="szChannelGateNo" name="szChannelGateNo" /></td>               
                    <th>名称：</th>
                    <td>
                        <input id="szChannelGateName" name="szChannelGateName" class="validate[required]" /></td>
                </tr>               
                <tr>                   
