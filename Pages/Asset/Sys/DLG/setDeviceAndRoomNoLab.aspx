<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="setDeviceAndRoomNoLab.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            <table>
                <tr>
                    ...
                    <td>
                        <input id="szRoomNo" name="szRoomNo" class="validate[required]" title="管理员请不要修改" /></td>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            ...
            AutoDevKind($("#szKindName"),2,$("#dwKindID"),<%=uClassKind%>,false);
        setTimeout(function () {           
        }, 1);
        });
    </script>
