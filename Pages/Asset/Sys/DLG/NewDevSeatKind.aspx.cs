    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            if (uNew == 1)
            {
                ...
                {
                    MessageBox("新建" + ConfigConst.GCSysKindSeat + ConfigConst.GCKindName + "成功", "提示", MSGBOX.SUCCESS, MSGBOX_ACTION.OK);                   
                }
                else
                {
            ...
            {
                MessageBox(m_Request.szErrMessage, "新建" + ConfigConst.GCSysKindSeat + ConfigConst.GCKindName + "失败", MSGBOX.ERROR, MSGBOX_ACTION.NONE);
            }
            else
            {
                MessageBox("新建" + ConfigConst.GCSysKindSeat + ConfigConst.GCKindName + "成功", "提示", MSGBOX.SUCCESS, MSGBOX_ACTION.OK);
        ...
        {
            m_Title = "新建" + ConfigConst.GCSysKindSeat + ConfigConst.GCKindName;
        }
    }
