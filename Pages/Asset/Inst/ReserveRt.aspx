...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2><%=ConfigConst.GCDevName %>使用预约管理</h2>
        <div class="toolbar">
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $(".OPTD1024").html('<div class="OPTDBtn">\
                       <a class="setLabBtn" title="预收费"><img src="../../../themes/icon_s/17.png"/></a></div>');
                ...
                $(".OPTD2097152").html('<div class="OPTDBtn">\
                       <a class="setLabBtn" title="入账"><img src="../../../themes/icon_s/6.png"/></a></div>');
                $(".OPTD4194304").html('<div class="OPTDBtn">\
                       <a class="setLabBtn" title="打印"><img src="../../../themes/icon_s/11.png"/></a></div>');
                $(".OPTDBtn").UIAPanel({
