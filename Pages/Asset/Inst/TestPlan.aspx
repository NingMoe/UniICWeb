<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="TestPlan.aspx.cs" Inherits="Sub_Plan" %>
            ...
            $(function () {
                ...
                $(".DoItemSet").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/SetTestPlan.aspx?op=set&id=' + dwID
                    });
                });
                ...
                $("#newPlan").click(function () {
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/NewTestPlan.aspx?op=new'
                    });
                });
            });
        </script>
