...
public partial class Sub_Course : UniPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UNIROOM[] room = GetRoomByClassKind((uint)UNIDEVCLS.DWKIND.CLSKIND_COMPUTER);
        ...
        UNIDEVKIND[] devKind = GetDevKindByKind((uint)UNIDEVCLS.DWKIND.CLSKIND_COMPUTER);
        ...
        if (uResponse == REQUESTCODE.EXECUTE_SUCCESS)
        {
            for (int i = 0; i < vrResult.Length; i++)
            {
                ...
                m_szOut += "<td class='lnkDevice' data-id='" + vrResult[i].dwDevID.ToString() + "' data-labid=\"" + vrResult[i].dwLabID.ToString() + "\">" + vrResult[i].szDevName.ToString() + "</td>";
                m_szOut += "<td>" + vrResult[i].szPCName.ToString() + "</td>";             
