<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="DevRoomListGradute.aspx.cs" Inherits="Sub_Course" %>

<%@ Register Src="~/Modules/PageCtrl.ascx" TagPrefix="uc1" TagName="PageCtrl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2 style="margin-top: 10px; font-weight: bold"><%=szDevNameURL %>使用状况</h2>
        <div class="tb_info">
            <div class="UniTab" id="tabl">
                <a href="DevRoomListGradute.aspx?dwClassKind=<%=uClassKind %>" id="DevRoomList"><%=szDevNameURL %>使用状况</a>
                <a href="DevRoomDoorCardRecGradute.aspx?dwClassKind=<%=uClassKind %>" id="DevRoomDoorCardRec"><%=szDevNameURL %>刷卡记录</a>
            </div>
        </div>
