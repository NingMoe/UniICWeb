...
<form id="Form1" runat="server">
    ...
    <div class="formtable">
        <table>
            <tr><td>　　　编号：</td><td><div id="dwStaSN" name="dwStaSN"></div></td></tr>
            <tr><td>　　　名称：</td><td><input id="szStaName" name="szStaName"/></td></tr>
            ...
            <tr><td>　所属部门：</td><td><input type="hidden" id="szDeptName" name="szDeptName"/><select id="dwOwnerDept" name="dwOwnerDept"><%=m_szDept %></select></td></tr>
            <tr><td>负责人账号：</td><td><input type="hidden" id="dwManagerID" name="dwManagerID"/><input type="hidden" id="szManName" name="szManName"/><input id="szManName2"/></td></tr>
