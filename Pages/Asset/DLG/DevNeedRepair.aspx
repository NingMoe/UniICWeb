<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="DevNeedRepair.aspx.cs" Inherits="_Default"%>
  ...
  <input type="hidden" id="selectID" name="selectID" />
    <div class="formtable">
        ...
        <div style="width:80%;margin:0px auto;" >
            勾选仪器:<a href="#" style="color:blue;text-decoration:underline" id="aSelect" select="false">全选</a>
        ...
        <div style="margin:0px auto;">
            ...
            <button type="submit" id="OK">选中仪器禁用</button><button type="button" id="Cancel">关闭窗口</button>
        </div>
