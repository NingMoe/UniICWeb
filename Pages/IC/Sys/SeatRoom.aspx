...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2><%=ConfigConst.GCSysKindSeat%>所在区域</h2>
                ...
                <thead>
                    <tr>
                      ...
                      <!--  <th name="szLabName">所属<%=ConfigConst.GCLabName %></th>-->
                        <th>该<%=ConfigConst.GCRoomName%><%=ConfigConst.GCSysKindSeat %>总数</th>
                        <th>当前该<%=ConfigConst.GCRoomName%>空闲<%=ConfigConst.GCSysKindSeat %>数</th>
                        <th name="szOpenRuleName">开放规则</th>    
                         <%if(ConfigConst.GCICLabRoom==1) {%> <th name="szLabName">所属<%=ConfigConst.GCLabName %></th>   <%} %>                                           
                        <th width="25px"></th>
                    </tr>
                </thead>
                <tbody id="ListTbl">
