...
public partial class Sub_Device : UniPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (m_Request.Device.Get(vrParameter, out vrResult) == REQUESTCODE.EXECUTE_SUCCESS)
        {
            ...
            {
                m_szOut += "<tr>";
                m_szOut += "<td data-id='" + vrResult[i].dwDevID.ToString() + "' data-kindid='" + vrResult[i].dwKindID.ToString() + "' data-labid='" + vrResult[i].dwLabID.ToString() + "'>" + vrResult[i].szAssertSN + "</td>";
