<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="LendKind.aspx.cs" Inherits="Sub_Device" %>

<%@ Register Src="~/Modules/PageCtrl.ascx" TagPrefix="uc1" TagName="PageCtrl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2><%=ConfigConst.GCSysKindLend %><%=ConfigConst.GCKindName %></h2>
        <div class="toolbar">
            <div class="tb_info">
            ...
            <div class="FixBtn">
                <a id="btnNew" class="btnClss">新建<%=ConfigConst.GCSysKindLend+ConfigConst.GCKindName %></a>
            </div>
        </div>
        <div>
            ...
            $(function () {
                ...
                $(".setDev").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/setDevkind.aspx?op=set&dwClassKind=4&id=' + dwDevKind
                    });
                });
                ...
                $("#btnNew").button()
                    .click(function () {
                        $.lhdialog({
                            ...
                            lock: true,
                            data: Dlg_Callback,
                            content: 'url:Dlg/newDevkind.aspx?op=new&dwClassKind=4'
                        });
                    });              
            });
