...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        ...
        <div class="toolbar">
            ...
            <div class="FixBtn"><a id="btnResvRule">新建控制台</a>
                <a id="btnOutPortini">生成配置文件</a>
            </div>
            <div class="tb_btn">
            </div>
        </div>
        <div class="content">
            <table class="ListTbl">
                <thead>
                    <tr>
                        <th name="dwConsoleSN">控制台编号</th>
                        <th name="szConsoleName">名称</th>
                        <th name="szIP" name="szIP">IP地址</th>
                        <th name="dwOpenTime">开放时间</th>
                        <th>类型</th>
                        <th>对象</th>
            ...
            $(function () {
                ...
                $("#btnOutPortini").click(function () {
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/outPortContrl.aspx'
                    });
                });
