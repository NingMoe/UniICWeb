<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetDevKind.aspx.cs" Inherits="_Default"%>
  ...
  <form id="Form1" runat="server">
        ...
        <div class="formtable">            
            ...
            <table>
                ...
                <tr>
                     <th></th>
                    <td colspan="3"><LABEL><INPUT class="enum" value="1" type="checkbox" name="isOpen" /> 不对外开放</LABEL></td>
                </tr>
                <tr>
