    ...
    <div class="formtable">  
        ...
        <table>
            ...
            <tr class="trInput">
             ...
             <tr>
        <th>禁止学生自由选择时间</th><td align="left"><input type="checkbox" class="chb" ID="chbLimit" runat="server" /></td>
            </tr>
        </table>     
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(function () {      
            ...
            $("#<%=chbLimit.ClientID%>").click(function () {
                MessageBox('请勿轻易选择此项，勾选后学生不能自由选择时间，如无响应规定学生不能预约成功', "重要提示", 1);
            });
