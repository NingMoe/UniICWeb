<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewRoomSeatDev.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            <table>
                ...
                <tr>
                   ...
                   <th>控制方式：</th>
                    <td><select id="dwCtrlMode" name="dwCtrlMode"><option value="1">门禁</option></select></td>
                    <th>资产号：</th>
