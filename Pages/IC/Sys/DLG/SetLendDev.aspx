<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetLendDev.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="Form1" runat="server">
        <div class="formtitle"><%=m_Title %></div>                
        <input type="hidden" id="dwCtrlMode" name="dwCtrlMode" value="0" /><!--登录控制-->
        ...
        <div class="formtable">
            <table>
               ...
               <tr>
                 ...
                 <tr>
                    <th>FID卡号:</th>
                    <td colspan="3"><input type="text" name="szTagID" id="szTagID" /></td>
                </tr>              
                <tr>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        AutoDevKind($("#szKindName"), 2, $("#dwKindID"), 4, false);
        AutoRoom($("#szRoomName"),2,$("#dwRoomID"),4,$("#dwLabID"));
        $("#OK").button();
