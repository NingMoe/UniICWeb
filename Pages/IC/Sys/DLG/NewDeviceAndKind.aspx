<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NewDeviceAndKind.aspx.cs" Inherits="_Default" %>
            ...
            <table>
                ...
                <th>管理员电话：</th>
                 ...
                 <tr>
                    ...
                    <th>国别：</th>
                    <td>
                        <input id="szNation" name="szNation" /></td>                                  
                </tr>            
                <tr>
                 ...
                 <tr>
                    <th>所属类型：</th>
                    <td>
                        <select id="dwClassID" name="dwClassID">
                            <%=m_szDevCls %>
                        </select></td>
