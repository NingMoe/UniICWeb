<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="GroupTest.aspx.cs" Inherits="Sub_Device" %>
            ...
            <table class="ListTbl">
                <thead>
                    <tr>
                        ...
                        <th>计算机名</th>
                         <th>IP地址</th>
                        <th name="dwBeginDate">所属<%=ConfigConst.GCKindName %></th>
                        <th>型号</th>
                        <th>规格</th>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#OPTDCTRL").html('<div class="OPTDBtnSet">\
                            ...
                            <a href="javascript:fAllOp("shutdown")" title="免登录"><img src="../../../themes/icon_s/15.png"/></a>\
                            <a href="javascript:fAllOp("restart")" title="需要登录"><img src="../../../themes/icon_s/13.png"/></a>\
