            ...
            $(function () {
               var tabl= $(".UniTab").UniTab();
                ...
                $(".OPTDBtnRec").html('<div class="OPTDBtn">\
                    <a href="#" class="DevUseGroup" title="免预约使用人员"><img src="../../../themes/iconpage/freedoorin.png"/></a>\
                    <a class="openDoor" href="#" title="远程开门"><img src="../../../themes/iconpage/opendoor.png"/></a>\
                    <a href="#" class="devDoorCard" title="刷卡记录"><img src="../../../themes/iconpage/record.png"/></a>\
                    <a href="#" class="DevUseGroupCopy" title="复制免预约使用人员"><img src="../../../themes/iconpage/Copyfreedoorin.png"/></a>\</div>');
                ...
                */
                $(".DevUseGroup").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/setusegroup.aspx?op=set&dwID=' + groupID
                    });
                });
