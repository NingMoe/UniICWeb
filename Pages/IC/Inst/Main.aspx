    ...
    <div id="tabs">
        <ul>
           ...
           <!--  <li><a href="feedback.aspx">意见反馈</a></li> -->
            ...
            <%string szVollet = "false"; try { szVollet = System.Web.Configuration.WebConfigurationManager.AppSettings["CastVote"]; }
              catch { } if (szVollet=="1") { %>
            <li><a href="PollLine.aspx">投票</a></li>
           <%} %>
             <%if (nIsAdminSup == 1 || szAdminPar.IndexOf("ReserveRoomList") > -1) {%>
             
            <li><a href="<%=szResvList %>">预约状况</a></li>
         <% if (szfunctionMode != null && (Parse(szfunctionMode) & 2) > 0)
             { %>   
