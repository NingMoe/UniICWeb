...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
            <h2 style="margin-top:10px;font-weight:bold">程序监控</h2>
        ...
        <div style="margin-top:30px;width:99%;">
            ...
            <table id="tbSearch" style="margin:0 auto;border:1px solid #d1c1c1">    
                ...
                <tr>
                    ...
                    <%=m_szRoom %><button type="button" id="btswctrl">设置房间临时监控</button>
                            </td>
                </tr>
                <%} %>
            ...
            $(function () {
               var tabl= $(".UniTab").UniTab();
                ...
                $(".OPTDBtnRec").html('<div class="OPTDBtn">\
                    <a href="#" class="SWCTRL" title="设置监控模式"><img src="../../../themes/icon_s/5.png"/></a>\</a>\</div>');
