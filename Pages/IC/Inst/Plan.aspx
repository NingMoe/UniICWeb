...
<form id="formAdvOpts" runat="server">
    <h2>课程实验计划</h2>
    <div class="toolbar">
        <div class="tb_info">总数：0条 , 已安排：0条，未安排：0条</div>
        <div class="FixBtn"><a>导入实验计划</a><a>同步教务处实验计划</a><a id="newPlan">手动添加实验计划</a></div>
        <div class="tb_btn">
    ...
    <div class="content">
        <table class="ListTbl">
            <thead>
                <tr><th width="60px">编号</th><th width="60px">计划名称</th><th width="60px">学期</th><th width="60px">教师</th><th>班级</th><th>课程</th><th>学时</th><th>状态</th><th width="25px">操作</th></tr>
            </thead>
            <tbody id="ListTbl">
                <%=m_szOut %>
            </tbody>
    ...
    <script type="text/javascript">
        $(function () {
            $(".OPTD").html('<div class="OPTDBtn">\
                        ...
                        <a href="#" class="DoItemDel" title="删除"><img src="../../../themes/icon_s/5.png"/></a>\</div>');
            $(".OPTDBtn").UIAPanel({
