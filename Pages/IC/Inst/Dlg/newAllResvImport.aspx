<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="newAllResvImport.aspx.cs" Inherits="_Default" %>
...
<%if(pagedata.dwStep == 0){ %>
        <div id="Step1">
            ...
            <br /><hr />
            <p>导入文件例子(<a href="../../DownLoadFile/AllResvImport.csv">点击下载</a>):</p>
            <%=m_szOut %>
        </div>
