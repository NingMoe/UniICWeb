...
public partial class Sub_Room : UniPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            dwStartDate.Value = DateTime.Now.AddDays(-10).ToString("yyyy-MM-dd 00:00");
            dwEndDate.Value = DateTime.Now.ToString("yyyy-MM-dd 23:00");
        }
        ...
        vrParameter.dwStartTime = Get1970Seconds(dwStartDate.Value);
        vrParameter.dwEndTime = Get1970Seconds(dwEndDate.Value);
