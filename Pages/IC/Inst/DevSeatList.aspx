            ...
            <table id="tbSearch" style="margin:0 auto;border:1px solid #d1c1c1">                                    
               <tr>
                ...
                <%if((ConfigConst.GCDevListMode&16)>0) {%>  
                 <tr>
                    <td  style="width:20%; text-align:center"><%=ConfigConst.GCSysKindSeat %>分配状态</td>
                    <td style="width:75%;text-align:left">                        
                          <LABEL><INPUT class="enum" value="1" type="checkbox" name="dwRunStat2" >未分配</LABEL>
                          <LABEL><INPUT class="enum" value="2" type="checkbox" name="dwRunStat" >已分配</LABEL>                         
                    </td>
                    </tr>
                <%if(isSmart==true) {%>
                 <tr>
                    <td  style="width:20%; text-align:center"><%=ConfigConst.GCSysKindSeat %>使用状态</td>
                    <td style="width:75%;text-align:left">                                                                
                           <LABEL><INPUT class="enum" value="524288" type="checkbox" name="dwRunStat" >有人</LABEL>                       
                        <LABEL><INPUT class="enum" value="1048576" type="checkbox" name="dwRunStat" >无人</LABEL>     
                    </td>
                    </tr>
                <%} %>
               <%} %>
                <tr>
                    <td><%=ConfigConst.GCSysKindSeat %>名称</td>
            ...
            <table class="ListTbl">
                <thead>
                    ...
                    <th></th>                       
                        ...
                        <th name="dwRunStat"><%=ConfigConst.GCSysKindSeat %>状态</th>                                                                              
                        <th>所属区域</th>  
