<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="ResvMoelStat.aspx.cs" Inherits="Sub_Course" %>

<%@ Register Src="~/Modules/PageCtrl.ascx" TagPrefix="uc1" TagName="PageCtrl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2 style="margin-top: 10px; margin-bottom: 20px; font-weight: bold">预约方式统计</h2>        
        ...
        <div class="content">
            ...
            <table class="ListTbl">
                <thead>
                    ...
                    <tr>
                        <th width="100px">预约方式</th>
                        <th name="dwUseTimes">预约人数</th>
                        <th name="dwUseTimes">预约次数</th>
                        <th name="dwUseTime">预约总时间</th>
                    </tr>
                </thead>
                <tbody id="ListTbl">
                    <%=m_szOut %>
