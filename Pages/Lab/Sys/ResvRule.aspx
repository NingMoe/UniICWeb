        ...
        <script type="text/javascript">
            $(function () {
                ...
                $(".OPTD").html('<div class="OPTDBtn">\
                        ...
                        <a href="#" class="setOpenTeacTime" title="设置开放周次"><img src="../../../themes/icon_s/13.png"/></a>\<%if(ConfigConst.GCDebug==1){%><a class="CopyResvRule"  href="#" title="复制给其他设备"><img src="../../../themes/iconpage/edit.png"/></a>\<%}%></div>');
                $(".OPTDBtn").UIAPanel({
                ...
                $(".setOpenTeacTime").click(function () {
                    var szLabSN = $(this).parents("tr").children().first().text();
                    var dwLabID = $(this).parents("tr").children().first().attr("data-id");
                    $.lhdialog({
                        title: '设置开放周次',
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/SetResvRuleOpen.aspx?op=set&dwID=' + dwLabID
                    });
                });
