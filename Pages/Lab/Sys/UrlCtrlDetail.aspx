<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="UrlCtrlDetail.aspx.cs" Inherits="Sub_Device"%>
        ...
        $(function () {
            ...
            $("#newBtn").click(function () {
                ...
                $.lhdialog({
                    ...
                    lock: true,
                    data: Dlg_Callback,
                    content: 'url:Dlg/setUrl.aspx?type=1&op=new&id=' + vClassID
                });
            });
