<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="UrlCtrl.aspx.cs" Inherits="Sub_Device"%>
        ...
        $(function () {
            ...
            $("#newBtn").click(function () {
                $.lhdialog({
                    ...
                    lock: true,
                    data: Dlg_Callback,
                    content: 'url:Dlg/SetClassF.aspx?op=new&type=url'
                });
            });
            $(".setBtn").click(function () {                
                ...
                $.lhdialog({
                    ...
                    lock: true,
                    data: Dlg_Callback,
                    content: 'url:Dlg/SetClassF.aspx?op=set&type=url&id=' + dwID
                });
            });
