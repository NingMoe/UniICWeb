            ...
            <table>
                ...
                <tr style="vertical-align: top;">
                    ...
                    <td style="text-align: left;width:200px;">
                        <select id="dwIdent" name="dwManRole"><%=szIdent %></select><a href="#" id="btnAddRole">添加身份</a></td>
                    <th>成员学工号：</th>
                    <td style="text-align: left">
        ...
        $(function () {
            ...
            $(".ui-icon-trash").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    dataType:'text',
                url:"../../data/DelGroupMember.aspx",
                data:{ GroupID: GroupID, MemberID: MeberID, KindID: KindID },
