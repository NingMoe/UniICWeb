...
public partial class _Default : UniPage
{
    ...
    void Import(string szFilePath, string szErrListRawFile, out uint nImported, out uint nFailed)
    {
        ...
        while ((strline = mysr.ReadLine()) != null)
        {
            ...
            if (GetAccByLogonName(szSLogonName.Trim(), out studentAcc,true))
            {
                UNITEACHER uniTeacher=new UNITEACHER();
                uniTeacher.dwAccNo = studentAcc.dwAccNo;
                uniTeacher.szTrueName = studentAcc.szTrueName;
                uniTeacher.szHandPhone = szSHandPhone;
                uniTeacher.szEmail = szSEmail;
                if (m_Request.Account.TeacherSet(uniTeacher, out uniTeacher) != REQUESTCODE.EXECUTE_SUCCESS)
                {
                ...
                else
                {
                    ...
                    if (GetAccByAccno(uniTeacher.dwAccNo.ToString(), out accinfo))
                    {
