<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="setPasswd.aspx.cs" Inherits="_Default" %>
        ...
        <div class="formtable">
            ...
            <table>
                ...
                <tr>
                    <th>密码：</th>
                    <td>
                        <input type="password" id="szPasswd1" name="szPasswd1"  /></td>
                   <th>重复密码</th>
                       <td>
                           <input type="password"  id="szPasswd2" name="szPasswd2"  /></td>
