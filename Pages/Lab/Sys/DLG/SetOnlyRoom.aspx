<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetOnlyRoom.aspx.cs" Inherits="_Default" %>
              ...
              <table>
                ...
                <tr>                   
                 ...
                 <%if(ConfigConst.GroomNumMode==1) {%>
                  <tr>
                      <th>管理员组</th>
                      <td><select id="manGroupID2" name="manGroupID2"><%=szManGroup %></select></td>
                      </tr>
                  <%} %>
                      <tr>                  
                    <th>控制方式：</th>
                    <td colspan="2">
                        <%=szManModeList %>
                          ...
                          <td colspan="1">
                             <label><input name="dwProp" id="dwProp" class="enum" type="checkbox" value="1" /> 不开放</label>
                          </td>
                </tr> 
