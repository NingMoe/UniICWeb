<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetAdminRoomNumMode.aspx.cs" Inherits="_Default"%>
   ...
   $(function () {        
        ...
        function SetManagerArea(vManRole) {
            debugger;
                ...
                else if ((vManRole & 1048576)>0) {//房间管理员
                    /*
                    vdivradLab.hide();
                    vdivcheckLab.hide();
                    vdivRoom.show();
