...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        <h2><%=szDevName%><%=ConfigConst.GCKindName %>管理</h2>
        <div class="toolbar">
            <div class="tb_info">
                <div class="UniTab" id="tabl">
                    <a href="DevAndRoomList.aspx?classKind=<%=uClassKind%>" id="DevAndRoomList"><%=szDevName%>管理</a>
            ...
            <div class="FixBtn">
                <a id="btnNew" class="btnClss">新建<%=szDevName+ConfigConst.GCKindName %></a>
            </div>
        </div>
        <div>
        ...
        <div class="content">
            <table class="ListTbl">
                <thead>
                    <tr>
                        <th name="szKindName"><%=szDevName%><%=ConfigConst.GCKindName %>名称</th>
            ...
            $(function () {
                ...
                $(".setDev").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/setRoomKind.aspx?op=set&id=' + dwDevKind + '&dwClassKind=<%=uClassKind%>'
                    });
                });
                ...
                $("#btnNew").button()
                    .click(function () {
                        $.lhdialog({
                            ...
                            lock: true,
                            data: Dlg_Callback,
                            content: 'url:Dlg/newRoomKind.aspx?op=new&dwClassKind=<%=uClassKind%>'
                        });
                    });              
            });
