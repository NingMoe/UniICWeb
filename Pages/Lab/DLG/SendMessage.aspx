<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SendMessage.aspx.cs" Inherits="_Default"%>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
<form id="Form1" runat="server">    
    <div class="formtitle"><%=m_Title %></div>
  <input type="hidden" id="selectID" name="selectID" />
    <div class="formtable" style="margin-top:20px">
      <div style="float:left;margin-left:75px;margin-top:0px;font-weight:bold;margin-right:10px">
                <div id="roomList">
        ...
        <div style="width:99%">
            <hr style="border:1 dashed #987cb9" width="80%" />
            </div>
        <div style="width:80%;margin:20px auto;">
            <div style="float:left;margin-left:0px;margin-top:20px;font-weight:bold;margin-right:10px">发送通知内容:</div><textarea type="text" style="width:400px;height:70px" id="szMessageInfo" name="szMessageInfo"  class="validate[required]" ></textarea>
        </div>
         <div style="width:99%">
            <hr style="border:1 dashed #987cb9" width="80%" />
            </div>
        <div style="margin:0px auto;">
            ...
            <button type="submit" id="OK">发送消息</button><button type="button" id="Cancel">关闭窗口</button>
        </div>
