<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="PowerDownPCmroom.aspx.cs" Inherits="_Default"%>
  ...
  <input type="hidden" id="selectID" name="selectID" />
    <div class="formtable">
        ...
        <div style="margin:0px auto;">
            ...
            <button type="submit" id="OK">关闭选中电脑</button><button type="button" id="Cancel">关闭窗口</button>
        </div>
