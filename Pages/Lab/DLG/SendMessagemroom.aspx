<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SendMessagemroom.aspx.cs" Inherits="_Default"%>
...
<form id="Form1" runat="server">    
  ...
  <input type="hidden" id="selectID" name="selectID" />
    <div class="formtable" style="margin-top:20px">
        ...
        <div class="tb_infoInLine" style="height:250px;overflow:scroll;margin-top:20px;">
            <table id="" class="UniTable">
                <thead>
                    <tr>
