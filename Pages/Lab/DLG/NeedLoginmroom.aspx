<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NeedLoginmroom.aspx.cs" Inherits="_Default"%>
  ...
  <input type="hidden" id="selectID" name="selectID" />
    <div class="formtable">
        ...
        <div style="margin:0px auto;">
            ...
            <button type="submit" id="OK">发送免登陆命令</button><button type="button" id="Cancel">关闭窗口</button>
        </div>
