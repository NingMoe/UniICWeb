<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="NoLoginResv.aspx.cs" Inherits="_Default"%>
...
<form id="Form1" runat="server">    
  ...
  <input type="hidden" id="selectID" name="selectID" />
    ...
    <div>
        ...
        <div>
             教师工号:<input type="text" id="szTestName" name="szTestName" class="validate[required]" />
        </div>
        </div>
         <div>
            <hr style="color:#999" width="99%" size="1" />
