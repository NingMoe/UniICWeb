    ...
    <div class="LoginContent">
        <div id="PanelContent">
            <div class="Box" theme="login.png" borderWeight="20px" width="400px" height="250px">
                ...
                <div class="LoginForm">
                    <table>
                        <tr><td><div class="label" title="ÕËºÅ">ÕËºÅ£º</div><asp:TextBox class="input" ID="szLogonName" runat="server"></asp:TextBox><div class="clear"></div></td></tr>
                        ...
                        <tr><td><br /><asp:Button class="button enabled" title="" ID="Button_Logon" runat="server" OnClick="Button_Logon_Click" Text="µÇÂ¼" /> <input type="button" class="button enabled" value="Ö÷Ò³" onclick="location = '../../clientweb/default.aspx'"/></td></tr>
