<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="PlaticTeachResvRec.aspx.cs" Inherits="Sub_Room" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        ...
        <input type="hidden" id="dwCourseID" name="dwCourseID" /> 
          <h2 style="margin-top:10px;font-weight:bold">考勤记录</h2>
            <div class="toolbar">
        <div class="tb_info">
                ...
                $("#<%=dwStartDate.ClientID%>,#<%=dwEndDate.ClientID%>").datepicker({
                 ...
                 $("#outplan").click(function () {
                    ...
                    $.lhdialog({
                        ...
                        lock: true,
                        data: Dlg_Callback,
                        content: 'url:Dlg/platicTeachResvOutExport.aspx?op=set&dwStartDate=' + dwStartDate + "&dwEndDate=" + dwEndDate + "&dwTeacherID=" + dwTeacherID + "&dwCourseID=" + dwCourseID
                    });
