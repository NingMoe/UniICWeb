    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (m_Request.Fee.BillGet(vrParameter, out vrResult) == REQUESTCODE.EXECUTE_SUCCESS)
        {
            for (int i = 0; i < vrResult.Length; i++)
            {
                ...
                m_szOut += "<td>" + ((float)(vrResult[i].dwUnitFee /(100.0))).ToString("0.00") + "元/小时</td>";
                m_szOut += "<td>" + (vrResult[i].dwUnitTime) + "分钟</td>";
             ...
             //   m_szOut += "<td>" + vrResult[i].dwFeeType + "</td>";
                ...
                m_szOut += "<td>" + GetJustName(vrResult[i].dwStatus, "UNIBILL_Status", false) + "</td>";  
