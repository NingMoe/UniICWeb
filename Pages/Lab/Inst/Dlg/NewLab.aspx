...
<form id="Form1" runat="server">
    ...
    <div class="formtable">
        ...
        <table>
            <tr><td>编号：</td><td><input id="szLabSN" name="szLabSN" class="validate[required]" /></td></tr>
            <tr><td>名称：</td><td><input id="szLabName" name="szLabName"  class="validate[required]" /></td></tr>
            <tr><td>类型：</td><td><select id="dwClass" name="dwClass"><%=m_szLabKind %></select></td></tr>
            <tr><td>所属<%=ConfigConst.GCDeptName %>：</td><td><input type="hidden" id="szDeptName" name="szDeptName"/><select id="dwDeptID" name="dwDeptID"><%=m_szDept %></select></td></tr>
