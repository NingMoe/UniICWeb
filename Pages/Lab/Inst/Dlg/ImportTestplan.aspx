...
<%if(pagedata.dwStep == 0){ %>
        <div id="Step1">
            ...
            <br /><hr />
            <p>导入文件例子(<a href="../../DownLoadFile/TestPlan.csv">点击下载</a>):</p>
            <%=m_szOut %>
        </div>
<%} else if(pagedata.dwStep == 2){ %>
        <div id="Step2">
             <p class="header ui-widget-header"><span class="StepName">选择对应学期：</span><select id="dwYearTerm" name="dwYearTerm"><%=m_szTerm %></select></p>
