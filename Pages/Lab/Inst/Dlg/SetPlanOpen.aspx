<%@ Page Language="C#" MasterPageFile="~/Templates/Dlg.master" AutoEventWireup="true" CodeFile="SetPlanOpen.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <form id="Form1">
        ...
        <input name="dwTeacherID" id="dwTeacherID" type="hidden" />
         <input name="dwKind" id="dwKind" type="hidden" value="2" />
                    ...
                    <table class="ListTbl2">
                        ...
                        <tr>
                            <td colspan="4" style="text-align: center">
                                <input type="button" id="btnAddTestItem" value="新增" />
                                <input type="button" id="btnTestItemCancel" value="取消" />
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        $(function () {
         ...
         function () {
            ...
            function NewTestPlan() {
                ...
                $.get(
                     "../../data/newtestplan.aspx?kind=open",
                     formData,
                     function (data) {
                         if (data.indexOf("错误") > -1) {
                             MessageBox(data, "", 2);
