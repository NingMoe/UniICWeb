...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    <form id="formAdvOpts" runat="server">
        ...
        <div class="toolbar">
         ...
         <div style="margin-top:2px;width:99%;">  
                ...
                <table style="margin: 10px; width: 70%">
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>其他成员:</th>
                        <td colspan="3">
                             <input type="text" name="dwPIDOther" id="dwPIDOther" /></td>
                    </tr>
                    <tr>
                        <th>状态</th>
                        <td colspan="3">
                            ...
                            <label><input class="enum" value="1" type="radio" name="dwCheckStat">待管理员审核</label>
  ...
  <a class="OPTDCheck" title="审核"><img src="../../../themes/iconpage/edit.png"/></a>\
                    <a href="#" class="delLabBtn" title="删除"><img src="../../../themes/iconpage/del.png""/></a></div>');
                $(".OPTDBtn").UIAPanel({
