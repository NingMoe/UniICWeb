<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="DevRoomResvStateMeeting.aspx.cs" Inherits="Sub_Course" %>
    ...
    <form id="formAdvOpts" runat="server">
        ...
        <div class="content">
         ...
         <div style="margin-top:10px;text-align:center; MARGIN-RIGHT: auto;height:350px; overflow-y:hidden;" id="divResvStatue">
                   <iframe src="<%=MyVPath %>ClientWeb\pro\page\calendar.aspx?classKind=<%=uClassKind-1%>&click=false" style="width:90%;border:0px;height:99%;padding-bottom:10px;">
