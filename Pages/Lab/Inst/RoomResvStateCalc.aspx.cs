...
public partial class Sub_Course : UniPage
{
    ...
    protected string szStartDate = "";
    protected string szEndDate = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        UNITERM ternow;
        if (GetTermNow(out ternow))
        {
            szStartDate=GetDateStr(ternow.dwBeginDate);
            szEndDate=GetDateStr(ternow.dwEndDate);
        }
    }
