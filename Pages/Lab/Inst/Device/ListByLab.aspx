<%@ Page Language="C#" MasterPageFile="~/Templates/Sub.master" AutoEventWireup="true" CodeFile="ListByLab.aspx.cs" Inherits="ListByKind"%>
...
<form id="formAdvOpts" runat="server">
    ...
    <div class="content">
        ...
        <div class="BarStat tblBottomStat" data-color="2">
         ...
         <div class="BarStat tblBottomStat" data-color="2">
            <h1><span>--------</span><strong>台数</strong></h1>
            <p><span>房间1</span><strong>30</strong></p>
            <p><span>房间2</span><strong>60</strong></p>
        </div>
    </div>
