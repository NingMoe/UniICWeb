...
<asp:Content runat="server" ID="MyHead" ContentPlaceHolderID="HeadContent">
    ...
    <style>
        ...
        #info_tree .it_cls_list .nav_cls_li { margin-bottom: 5px; }
    </style>
    <script>
        //公共对象
        var content;//内容区域
        ...
        var uni_calendar_dft_opt = {
            cusPrepare: function (data, callback) {
                ...
                if (obj.type != "kind" && obj.prop && (parseInt(obj.prop) & 65536) > 0) {//是否支持开放活动 prop=65536这个属性是临时使用 所以暂定义在外层
                    ...
                    if (ov == "1") {//可选
                        uni.confirm("本设备支持开放活动，是否跳转到活动申请？", function () {
                        ...
                        <div class="col">
                            <div id="info_tree">
                                <div style="width: 263px;">
                                    <div url="../ic2/index.aspx" con="#detail_con" class="click_load click">
                                    ...
                                    <ul class="nav oth_list">
                                        <li><a url="../a/article.aspx?id=help&type=other" con="#detail_con" class="click_load"><span><span class="glyphicon glyphicon-question-sign"></span>&nbsp;<%=Translate("使用帮助")%></span></a></li>
                                        ...
                                        <li style="display: <%=((openAty=="1"||openAty=="2"))?"":"none" %>"><a url="../a/openatycenter.aspx?type=old" con="#detail_con" class="click_load"><span><span class="glyphicon glyphicon-bookmark"></span>&nbsp;<%=Translate("活动回顾")%></span></a></li>
                                        <li class="login_show" style="display: <%=GetConfig("CastVote")=="1"?"":"none"%>"><a url="../a/castvote.aspx" con="#detail_con" class="click_load"><span><span class="glyphicon glyphicon-signal"></span>&nbsp;<%=Translate("网上投票")%></span></a></li>
                                        <%--<li style="display: <%=GetConfig("mShowJumpManage")=="1"?"":"none" %>"><a href="../../../pages/default.aspx"><span class="glyphicon glyphicon-bookmark"></span>&nbsp;转到管理端</a></li>--%>
                                    </ul>
                                    <div class="line"></div>
                                    <div id="item_list">
