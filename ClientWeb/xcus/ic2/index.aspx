...
<body>
    ...
    <script>
        $(function () {
            if("<%=GetConfig("mIndexMode")%>"=="1")
            RetSelecteds();
            //pro.j.util.getFee();
            //通知
            var con=$(".box_notice .con").text();
            if(con.length>80)con=con.substr(0,80)+"...[<a>详细</a>]"
            $(".box_notice .con").html("<p>"+con+"</p>");
        });
        function RetSelecteds() {
            ...
            function SubmitRet(condition) {
                pro.j.dev.devFilter(condition, function (con) {
                    var mode =0<%=GetConfig("mIndexMode")%>;
                    var content = '';
                    rlt = con.data;
                    var devs = rlt.devs;
    ...
    <h1 class="h_title">Home Page</h1>
    <div class="line"></div>
    <div class="row">
        <div class="col col_8 devs_queue">
            <div class="<%=GetConfig("mIndexMode")=="1"?"hidden":"" %>">
                <div id="carousel_slider" class="carousel slide" data-ride="carousel" data-interval="3000">
                    ...
                    <div class="carousel-inner main_slide" role="listbox">
                        <%if (string.IsNullOrEmpty(clsSlide)){ %>
                        <div class="item active">
                            <img src="../../pro/dft/dft_index0.jpg" alt="...">
                            <div class="carousel-caption">
                            </div>
                        </div>
                        <div class="item">
                            <img src="../../pro/dft/dft_index1.jpg" alt="...">
                            <div class="carousel-caption">
                            </div>
                        </div>
                        <div class="item">
                            <img src="../../pro/dft/dft_index2.jpg" alt="...">
                            <div class="carousel-caption">
                            </div>
                        </div>
                        <%} %>
                ...
                <div class="text-center">
                    ...
                    <div class="line"></div>
                    <p class="grey">
                        <%=Translate("这是一种新型的空间，一种新型的学习模式，一种共享的交流社区。配置计算机、网络、有线电视、投影仪等设施及常用的专业软件，打通了通信载体、内容分类、物理空间的界限，提供资源的一站式服务，读者在享受最新的阅读体验的同时可以对空间进行多信息的交互和共享。")%>
                    ...
                    <div class="col col_4 intro_box">
                        <div class="box">
                            <div class="box-gray">
                                ...
                                <p class="grey">
                                   <%=Translate("大量设施完善管理有序的资源")%> 
                                </p>
                            </div>
                            <div class="box-bottom bg_color1">
                                <span><%=Translate("资源")%></span>
                            </div>
                        </div>
                    </div>
                    <div class="col col_4 intro_box">
                        <div class="box">
                            <div class="box-gray">
                                ...
                                <p class="grey">
                                  <%=Translate("信息化的共享管理方式")%>    
                                </p>
                            </div>
                            <div class="box-bottom bg_color1">
                                <span><%=Translate("共享")%></span>
                            </div>
                        </div>
                    </div>
                    <div class="col col_4 intro_box">
                        <div class="box">
                            <div class="box-gray">
                                ...
                                <p class="grey">
                                    <%=Translate("为广大读者提供更多优质的服务")%>    
                                </p>
                            </div>
                            <div class="box-bottom bg_color1">
                                <span><%=Translate("服务")%></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col col_4 pull-right" style="border-left: 1px dotted #ddd; min-height: 500px;">
            <div class="<%=GetConfig("mNotice")=="1"?"":"hidden" %>">
                <h3 class="h_title" style="margin-top: 0;"><%=Translate("最新通知")%>
                    <!--<small url="../a/articleList.aspx" class="noticeAll color1" style="margin-left:120px;text-decoration:underline">All</small>
                    -->
                </h3>

                <div class="box_notice" style="min-height: 100px; margin-bottom: 10px;">
                    <%=infoContent %>
                    <ul style="margin:8px 8px 15px 15px;">
                        <%=noticeList %>
                    </ul>
                </div>
            </div>
            ...
            <script>
                ...
                $(".h_title .noticeAll").clickLoad();
                pro.autoScroll.regist(".dyn_resv", 10);
            </script>
        </div>
    </div>
</body>
