<%@ Page Language="C#" AutoEventWireup="true" CodeFile="openatycenter.aspx.cs" Inherits="ClientWeb_xcus_all_openaty_center" %>
    ...
    <script>
        $(function () {
            $(".M-box2 .pageset").click(function () {
                ...
                $.post("../a/pagesnation.aspx?activityPage=" + pageNum, function (data) {
                    uni.reload();
                });
