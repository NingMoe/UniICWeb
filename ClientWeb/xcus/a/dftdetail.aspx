<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dftdetail.aspx.cs" Inherits="ClientWeb_xcus_all_detail" %>
...
<body>
    <form runat="server">
        ...
        <input runat="server" type="hidden" class="info_id" name="class_id" id="infoId" />
        <input runat="server" type="hidden" class="info_name" name="class_name" id="infoName" />
    </form>
    <div>
