...
public  class Uploader
{
  ...
  */
    ...
    {
        pathbase =rootPath+ pathbase + DateTime.Now.ToString("yyyy-MM-dd") + "/";//custom
 ...
 */
    ...
    {
        pathbase =rootPath+ pathbase + DateTime.Now.ToString("yyyy-MM-dd") + "/";
        uploadpath = cxt.Server.MapPath(pathbase);//获取文件上传路径
        FileStream fs = null;
        try
        {
...
*/
    ...
    {
        //custom
        //System.Guid.NewGuid()+getFileExt();
        ...
        return name + DateTime.Now.ToFileTime().ToString() + "." + temp[e].ToLower();
    }
    ...
    private  void createFolder()
    {
        if (!Directory.Exists(uploadpath))
        {
            ...
            {
                Logger.trace("上传文件创建失败:"+ex.ToString());
            }
        }
        else {
